...
def align_forcefield(structures, max_sizes, dtype=onp.float32):
    ...
    b_1_idx = onp.zeros(shape=(full_size,max_sizes['b_1_idx']), dtype=onp.int32)
    b_2_idx = onp.zeros(shape=(full_size,max_sizes['b_2_idx']), dtype=onp.int32)
    b_prm_idx = onp.zeros(shape=(full_size,max_sizes['b_prm_idx']), dtype=onp.int32)

    a_k = onp.zeros(shape=(full_size,max_sizes['a_k']), dtype=dtype)
    a_eq_ang = onp.zeros(shape=(full_size,max_sizes['a_eq_ang']), dtype=dtype)
    ...
    t_k = onp.zeros(shape=(full_size,max_sizes['t_k']), dtype=dtype)
    t_phase = onp.zeros(shape=(full_size,max_sizes['t_phase']), dtype=dtype)
    t_period = onp.zeros(shape=(full_size,max_sizes['t_period']), dtype=dtype)
    ...
    scnb = onp.zeros(shape=(full_size,max_sizes['scnb']), dtype=dtype)
    
    charges = onp.zeros(shape=(full_size,max_sizes['charges']), dtype=dtype)
    scee = onp.zeros(shape=(full_size,max_sizes['scee']), dtype=dtype)
