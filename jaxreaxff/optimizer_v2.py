...
# computes eem charges from reaxff forcefield and returns amber coulomb energy with those charges
...
def amber_eem_energy(pos,
  ...
  tprm = (amberPrms.t_k, amberPrms.t_phase, amberPrms.t_period, amberPrms.t_1_idx, amberPrms.t_2_idx
         , amberPrms.t_3_idx, amberPrms.t_4_idx, amberPrms.t_prm_idx)
  lprm = (amberPrms.pairs, amberPrms.pairs14, amberPrms.lj_type, amberPrms.sigma, amberPrms.epsilon, amberPrms.scnb)
  cprm = (amberPrms.charges, amberPrms.pairs, amberPrms.pairs14, amberPrms.scee)
  #print(amberPrms)
  #bprm, aprm, tprm, lprm, cprm, = amberPrms
...
def calculate_loss(force_field,
  ...
  # print("List Structure Length", len(list_structure))
  # print("Amber Params Length", len(amberPrms))
...
def train_FF(params, param_indices, param_bounds, force_field,
  ...
  for e in range(iter_count+1):
    ...
    # print("Amber Params Length TrainFF", len(amberPrms))
